...
const sendEmailResetPassword = (email, firstName, frontBaseUrl, code) => {
 ...
 <p style='font-size: 18px; line-height: 1.6; margin-bottom: 25px; text-align: center;'>Para actualizar la contrazeña. Por favor, haga clic en el siguiente enlace:</p>
