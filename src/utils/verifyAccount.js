...
const verifyAccount = (email, firstName, frontBaseUrl, code) => {
 ...
 <p style='font-size: 18px; line-height: 1.6; margin-bottom: 25px; text-align: center;'>Gracias por registrarte en nuestra aplicación. Para verificar su cuenta,<br> haga clic en el siguiente enlace:</p>
